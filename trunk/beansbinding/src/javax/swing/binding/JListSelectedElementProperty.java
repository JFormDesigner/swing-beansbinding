 ...
 * @author Scott Violet
 */
public final class JListSelectedElementProperty<S, E> extends AbstractProperty<S, E> {
    ...
    private JListSelectedElementProperty(Property<S, ? extends JList> sourceProperty, Class<E> valueType) {

...
/**
 * {@code REFPropertyResolver} is used to resolve a dot separated list of
 * properties against an object. Once bound, {@code REFPropertyResolver}
 ...
 * <p>
 * A bound {@code REFPropertyResolver} tracks changes using the following
 * algorithm:
 * <ol>
...
public final class REFPropertyResolver<S> extends PropertyResolver<S> {
    ...
    public void addPropertyChangeListener(PropertyChangeListener listener) {
        ...
        if (!hasListeners && getPropertyChangeListeners().length != 0) {
            hasListeners = true;
        }
    }
